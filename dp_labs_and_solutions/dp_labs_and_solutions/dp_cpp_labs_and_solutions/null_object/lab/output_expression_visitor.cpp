...
void output_expression_visitor::visit(method_invocation & a_method_invocation)
{
	...
	while (!a_iterator->is_done())
	{
		...
		{
			throw dp_exception("void output_expression_visitor::visit(method_invocation & a_method_invocation) -- a_operand1 == nullptr.");
		}
...
void output_expression_visitor::output_prefix(const unary & a_unary, const std::string & a_operator)
{
	...
	if (a_unary.get_operand1() == nullptr)
	{
		throw dp_exception("void output_expression_visitor::output_prefix(const unary & a_unary, const std::string & a_operator) -- a_unary.get_operand1() == nullptr.");
	}
...
void output_expression_visitor::output_postfix(const unary & a_unary, const std::string & a_operator)
{
	...
	if (a_unary.get_operand1() == nullptr)
	{
		throw dp_exception("void output_expression_visitor::output_postfix(const unary & a_unary, const std::string & a_operator) -- a_unary.get_operand1() == nullptr.");
	}
	a_unary.get_operand1()->accept(*this);
	my_stream << a_operator;
	my_stream << ")";
...
{
	my_stream << "(";
	if (a_binary.get_operand1() == nullptr)
	{
		throw dp_exception("void output_expression_visitor::output_infix(const binary & a_binary, const std::string & a_operator) -- a_binary.get_operand1() == nullptr.");
	}
	a_binary.get_operand1()->accept(*this);
	my_stream << a_operator;
	if (a_binary.get_operand2() == nullptr)
	{
		throw dp_exception("void output_expression_visitor::output_infix(const binary & a_binary, const std::string & a_operator) -- a_binary.get_operand2() == nullptr.");
	}
...
{
	my_stream << "(";
	if (a_ternary.get_operand1() == nullptr)
	{
		throw dp_exception("void output_expression_visitor::output_infix(const ternary & a_ternary, const std::string & a_operator1, const std::string & a_operator2) -- a_ternary.get_operand1() == nullptr.");
	}
	a_ternary.get_operand1()->accept(*this);
	my_stream << a_operator1;
	if (a_ternary.get_operand2() == nullptr)
	{
		throw dp_exception("void output_expression_visitor::output_infix(const ternary & a_ternary, const std::string & a_operator1, const std::string & a_operator2) -- a_ternary.get_operand2() == nullptr.");
	}
	a_ternary.get_operand2()->accept(*this);
	my_stream << a_operator2;
	if (a_ternary.get_operand3() == nullptr)
	{
		throw dp_exception("void output_expression_visitor::output_infix(const ternary & a_ternary, const std::string & a_operator1, const std::string & a_operator2) -- a_ternary.get_operand3() == nullptr.");
	}
