...
const driver::memento_interface * driver::backup() const
{
...
void driver::restore(const memento_interface * a_memento_interface)
{
	...
	{
		throw dp_exception("void driver::restore(memento_interface * a_memento_interface) -- a_memento_interface == nullptr.");
	}

	const memento_implementation * a_memento_implementation =
		dynamic_cast<const memento_implementation *>(a_memento_interface);
