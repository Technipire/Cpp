...
void expression_visitor::visit(binary_minus & a_binary_minus)
{
	...
	{
		throw dp_exception("void expression_visitor::visit(binary_minus & a_binary_minus) -- a_binary_minus.get_operand1() == nullptr.");
	}
	a_binary_minus.get_operand1()->accept(*this);
	if (a_binary_minus.get_operand2() == nullptr)
	{
		throw dp_exception("void expression_visitor::visit(binary_minus & a_binary_minus) -- a_binary_minus.get_operand2() == nullptr.");
	}
...
void expression_visitor::visit(binary_plus & a_binary_plus)
{
	...
	{
		throw dp_exception("void expression_visitor::visit(binary_plus & a_binary_plus) -- a_binary_plus.get_operand1() == nullptr.");
	}
	a_binary_plus.get_operand1()->accept(*this);
	if (a_binary_plus.get_operand2() == nullptr)
	{
		throw dp_exception("void expression_visitor::visit(binary_plus & a_binary_plus) -- a_binary_plus.get_operand2() == nullptr.");
	}
...
void expression_visitor::visit(conditional & a_conditional)
{
	...
	{
		throw dp_exception("void expression_visitor::visit(conditional & a_conditional) -- a_conditional.get_operand1() == nullptr.");
	}
	a_conditional.get_operand1()->accept(*this);
	if (a_conditional.get_operand2() == nullptr)
	{
		throw dp_exception("void expression_visitor::visit(conditional & a_conditional) -- a_conditional.get_operand2() == nullptr.");
	}
	a_conditional.get_operand2()->accept(*this);
	if (a_conditional.get_operand3() == nullptr)
	{
		throw dp_exception("void expression_visitor::visit(conditional & a_conditional) -- a_conditional.get_operand3() == nullptr.");
	}
...
void expression_visitor::visit(divide & a_divide)
{
	...
	{
		throw dp_exception("void expression_visitor::visit(divide & a_divide) -- a_divide.get_operand1() == nullptr.");
	}
	a_divide.get_operand1()->accept(*this);
	if (a_divide.get_operand2() == nullptr)
	{
		throw dp_exception("void expression_visitor::visit(divide & a_divide) -- a_divide.get_operand2() == nullptr.");
	}
...
void expression_visitor::visit(method_invocation & a_method_invocation)
{
	...
	while (!a_iterator->is_done())
	{
		...
		{
			throw dp_exception("void expression_visitor::visit(method_invocation & a_method_invocation) -- a_operand == nullptr.");
		}
...
void expression_visitor::visit(multiply & a_multiply)
{
	...
	{
		throw dp_exception("void expression_visitor::visit(multiply & a_multiply) -- a_multiply.get_operand1() == nullptr.");
	}
	a_multiply.get_operand1()->accept(*this);
	if (a_multiply.get_operand2() == nullptr)
	{
		throw dp_exception("void expression_visitor::visit(multiply & a_multiply) -- a_multiply.get_operand2() == nullptr.");
	}
...
void expression_visitor::visit(unary_minus & a_unary_minus)
{
	...
	{
		throw dp_exception("void expression_visitor::visit(unary_minus & a_unary_minus) -- a_unary_minus.get_operand1() == nullptr.");
	}
...
void expression_visitor::visit(unary_plus & a_unary_plus)
{
	...
	{
		throw dp_exception("void expression_visitor::visit(unary_plus & a_unary_plus) -- a_unary_plus.get_operand1() == nullptr.");
	}
